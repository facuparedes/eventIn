...
export default function Card({ id, title, description, dateStart, attachments, navigation, likedActive, latlng, created, likedBefore }) {
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("CardDetail", {
              ...
              likedBefore: likedBefore ? likedBefore : false
            })
          }
        >
